...
function ThemeSettings(props) {
  const { currentMode, currentColor, setThemeSettings, setColor, setMode } =
    useStateContext();
  return (
    <div className="bg-half-transparent w-full fixed nav-item top-0 right-0" onClick={() => setThemeSettings(false)}>
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:bg-[#42464D] dark:[#484B52] w-350 " onClick={(e) => e.stopPropagation()}>
